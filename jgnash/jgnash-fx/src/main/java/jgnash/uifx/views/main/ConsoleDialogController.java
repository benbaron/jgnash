/* jGnash, a personal finance application Copyright (C) 2001-2020 Craig
 * Cavanaugh This program is free software: you can redistribute it and/or
...
public class ConsoleDialogController
{
	...
	@InjectFXML private final ObjectProperty<Scene> parent = new SimpleObjectProperty<>();
	
	@FXML private ProgressBar memoryUsageProgressBar;
		...
		void initialize()
	{
		...
		timeline = new Timeline(new KeyFrame(Duration.millis(REFRESH_PERIOD),
	...
	@FXML private void handleCloseAction()
	{
	...
	@FXML private void handleForceGarbageCollection()
	{
		System.gc();
	}
	
	@FXML private void handleCopyToClipboard()
	{
	...
	private class LogHandler extends Handler
	{
		...
		{
			JavaFXUtils.runLater(
				() -> consoleArea.appendText(record.getMessage() + System.lineSeparator()));
		}
